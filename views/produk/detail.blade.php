                    ...
                    <div class="single-product-slider">
                        ...
                        <div class="single-product-gallery-item" id="slide1">
                            <a data-rel="prettyphoto" href="{{url(product_image_url($produk->gambar1,'large'))}}">
                                <img class="lazy" alt="" src="{{url(product_image_url($produk->gambar1))}}" />
                            </a>
                        </div>
                        @endif
                        @if($produk->gambar2 != '')
                        <div class="single-product-gallery-item" id="slide2">
                            ...
                            <img class="lazy" alt="" src="{{url(product_image_url($produk->gambar2))}}" />
                                </a>
                        </div>
                        @endif
                        @if($produk->gambar3 != '')
                        <div class="single-product-gallery-item" id="slide3">
                            ...
                            <img class="lazy" alt="" src="{{url(product_image_url($produk->gambar3))}}" />
                                </a>
                        </div>
                        @endif
                        @if($produk->gambar4 != '')
                        <div class="single-product-gallery-item" id="slide4">
                            ...
                            <img class="lazy" alt="" src="{{url(product_image_url($produk->gambar4))}}" />
                                </a>
                        </div>
                        @endif
